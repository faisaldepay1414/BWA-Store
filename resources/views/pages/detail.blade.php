      ...
      <section class="store-heading">
        <div class="container">
          <div class="row">
            <div class="col-lg-8">
              <h1>Sofa Nyaman</h1>
              <div class="owner">Faishal Al Barkah</div>
              <div class="price">$1,505</div>
            </div>
          ...
          <div class="row">
            <div class="col-12 col-lg-8">
              ...
              <p>
                ...
                inspired by the DNA of the iconic Air Max 90. Brand-new Nike Air cushioning underfoot adds
                unparalleled comfort while transparent mesh and vibrantly coloured details on the
                upper are blended with timeless OG features for an edgy, modernised look.
              </p>
            </div>
          </div>
        </div>
