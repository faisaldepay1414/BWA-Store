                ...
                <div class="row">
                  ...
                  <div class="col-md-4">
                    <div class="gallery-container mb-2">
                      <img src={{url("./images/My_Products/1.png")}} alt="" class="w-100">
                  ...
                  <div class="col-md-4">
                    <div class="gallery-container mb-2">
                      <img src={{url("./images/My_Products/2.png")}} alt="" class="w-100">
                      <a href="#" class="delete-gallery">
                        <img src={{url("./images/Dashboard/icon-delete.svg")}} alt="">
                      </a>
                    </div>
                  ...
                  <div class="col-md-4">
                    <div class="gallery-container mb-2">
                      <img src={{url("./images/My_Products/3.png")}} alt="" class="w-100">
                      <a href="#" class="delete-gallery">
                        <img src={{url("./images/Dashboard/icon-delete.svg")}} alt="">
                      </a>
                    </div>
